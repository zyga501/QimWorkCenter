        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <input name="enddate" id="enddate" class="form-control layer-date" placeholder="结束日期"
                       onclick="laydate({istime: true, format: 'YYYY-MM-DD'})"></div>
            <div class="col-md-3"><input name="outtradeno" type="text" class="form-control" placeholder="订单号"></div>
            <div class="col-md-2"><input name="submchid" type="text" class="form-control" placeholder="商户号"></div>
            <div class="col-md-1"><input  type="reset" class="form-control btn btn-danger" value="重置"></div>
        </div>
        <div class="row">
            <div class="col-md-3"><input name="storename" type="text" class="form-control" placeholder="商户名称"></div>
            <div class="col-md-3"><input name="username" type="text" class="form-control" placeholder="收银员"></div>
            <div class="col-md-3"><input name="amount" type="text" class="form-control" placeholder="金额(如=10 >10 <10)"></div>
            <div class="col-md-2"><input name="uname" type="text" class="form-control" placeholder="代理/销售编号"></div>
            <div class="col-md-1"><input  type="button" class="form-control btn btn-primary"
                                         onclick="searchlist(1)" value="检索"></div></div>
        </div>
    </div>
</form>
